...
var serialize$1 = (element, config2, indentation, depth, refs, printer) => ++depth > config2.maxDepth ? printElementAsLeaf(getType(element), config2) : printElement(
  getType(element),
  printProps(
...
var serialize = (object, config2, indentation, depth, refs, printer) => ++depth > config2.maxDepth ? printElementAsLeaf(object.type, config2) : printElement(
  object.type,
